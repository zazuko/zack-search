    ...
    return html`
      <sp-action-menu>
        ...
        <sp-menu-item @click="${this.onListClick()}">
          ...
          ${translate('zack-fav-menu.select-not-starred')}
        </sp-menu-item>
        <sp-menu-group>
          <span slot="header">${translate('zack-fav-menu.lists-header')}</span>
        ...
        <sp-menu-group ?hidden="${this.listedOn.length === 0}">
          <span slot="header">${translate('zack-fav-menu.notes')}</span>
          <sp-button quiet variant="primary" @click="${this.addNotes}">${translate('zack-fav-menu.edit-notes')}</sp-button>
        </sp-menu-group>
      </sp-action-menu>
    `
  }
