...
class ZackResult extends ZackComponent {
  static get properties () {
    return {
      ...
      range: { type: Object },
      subject: { type: Object, converter: (str) => namedNode(str) }
    }
  }
  ...
  render () {
    ...
    const intervalStarts = page.match(subject, this.app.terms.intervalStarts).toArray().shift()
    const intervalEnds = page.match(subject, this.app.terms.intervalEnds).toArray().shift()
