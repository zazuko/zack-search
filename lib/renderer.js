...
renderer.renderResult = function (page, subject) {
    ...
    hierarchyString = hierarchyString + 
        '<li>' +
          '<a id="' + id  + '" data-filterable="="' +
            ' data-toggle="tooltip" data-placement="bottom" title="' + nivShort + '"' +
  ...
  rendering = '<div class="zack-result row">' +
      '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">' + archive + timeTick + '<div class="result-hierarchy-clip"><ul class="result-hierarchy">' + hierarchyString + '</ul></div></div>' +
