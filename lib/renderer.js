...
renderer.renderResult = function (page, subject) {
  ...
  rendering = '<div class="zack-result row">' +
      '<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">' + level + '' + '<div class="result-main">' + timeTick + titleString + timeRange + '</br>' + reference + '</div></div>' +
      '<div class="col-lg-8 col-md-4 hidden-sm hidden-xs">' + maintenanceAgency + conceptTagDivs + '</div>' + 
      '</div>'
