...
Zack.prototype.getResultInterval = function (page, subject) {
  if (typeof this.options.getResultInterval === 'function') {
    return this.options.getResultInterval.call(this, page, subject)
  }

  const intervalStarts = page.match(subject, this.terms.intervalStarts).toArray().shift()
  const intervalEnds = page.match(subject, this.terms.intervalEnds).toArray().shift()
