...
filter.toHtml = function (label, instance) {
  return '<div data-filter="' + instance.operator + '" ' +
    'data-predicate="' + instance.predicate + '" ' +
    (instance.propertyPathPrefix ? 'data-property-path-prefix="' + instance.propertyPathPrefix + '" ' : '') +
    (instance.propertyPathPostfix ? 'data-property-path-postfix="' + instance.propertyPathPostfix + '" ' : '') +
    'data-value="' + instance.value.slice(1, -1) + '" ' +
    (instance.termType === 'NamedNode' ? 'data-named-node ' : '') +
